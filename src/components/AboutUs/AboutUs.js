  ...
  return (
    <div className={styles.container}>
      <div className={styles.about}>
        <h1>Nosotros</h1>
        <p>
          Bienvenidos a DANITEX DISTRIBUIDORA. Nos dedicamos a ofrecer prendas
      ...
      <div className={styles.mision}>
        <h5>Misión</h5>
        <p>
          Nuestra misión en DANITEX es ofrecer a nuestros clientes una
          ...
          de manera ética y respetuosa con el medio ambiente. En DANITEX, nos
      ...
      <div className={styles.vision}>
        <h5>Visión</h5>
        <p>
          En DANITEX, nuestra visión es convertirnos en la tienda en líder en
          ...
          En resumen, nuestra visión en DANITEX es liderar la industria de la
